...
/*
 * ConsolePainter Class
 * --------------------
 * This class provides methods to print simple colored tables and colored text to the console.
 *
 * Main Methods:
 * - CreateTable: Displays a list of objects as a formatted table with optional colors for headers and rows.
 * - Write / WriteLine: Prints colored text to the console.
 *
 * CreateTable Parameters:
 * - IEnumerable items: The list of objects to display in a table.
 * - ConsoleColor? headerColor (optional): Color for the table headers (default is White).
 * - ConsoleColor? rowColor (optional): Color for the table rows (default is White).
 *
 * Example Usage:
 *
 ...
 * };
 *
 * ConsolePainter.CreateTable(people, ConsoleColor.Green, ConsoleColor.DarkGray);
 *
 * Sample Output:
 *
 * Class: Person
 ...
 *
 * Note:
 * - "Class: Person" is printed in Yellow color.
 * - Table headers are printed in Green.
 * - Table rows are printed in Dark Gray.
 */
